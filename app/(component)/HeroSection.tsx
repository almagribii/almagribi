...
export const HeroSection = () => {
  return (
    <section className="flex min-h-[80vh] md:min-h-screen items-center justify-center flex-col pt-24 md:py-0" id="hero">
      <div className="max-w-7xl mx-auto w-full flex flex-col-reverse md:flex-row items-center justify-between p-4 space-y-10 md:space-y-0 md:space-x-12">
        ...
        <div className="w-full md:w-1/2 p-0 md:p-4 text-center md:text-left">
          ...
          <div className="flex flex-wrap justify-center md:justify-start items-center space-x-0 sm:space-x-4 space-y-4 sm:space-y-0 mt-8">
            <button className="bg-card font-medium py-3 px-6 sm:px-8 rounded-full transition duration-300 shadow-lg flex items-center justify-center space-x-2 w-full sm:w-auto text-card-foreground hover:bg-card/80">
              <FiDownload className="h-5 w-5" />
              <span>Download CV</span>
            </button>

            <button className="font-medium py-3 px-6 sm:px-8 rounded-full border border-card-foreground transition duration-300 shadow-lg flex items-center justify-center  space-x-2 w-full sm:w-auto hover:bg-card/20">
        ...
        <div className="w-full md:w-1/2 flex justify-center p-4 order-first md:order-last">
          ...
          >
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold mb-1">Brucad</h3>

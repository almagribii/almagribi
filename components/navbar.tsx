...
export const Navbar = () => {
  return (
    <div className="bg-card w-full flex justify-between items-center p-4 mt-4 shadow-xl rounded-full px-8 text-xs ">
      <div className="mt-1 hidden md:block text-xl font-bold">
